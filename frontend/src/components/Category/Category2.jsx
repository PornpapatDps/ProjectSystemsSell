    ...
    <div className='py-3'>
      <div className='container'>
        ...
        lg:grid-cols-9 gap-4 font-[Kanit]'>
          {/* first-col */}
          <div className='col-span-2 py-10 pl-6 bg-gradient-to-br from-black/90 to-brandBlue/90 text-white rounded-3xl relative h-[320px]
          flex items-end'>
            <div>
              <div className='mb-4'>
                <p className='mb-[3px] text-white-700'>ปลาน้ำจืด</p>
            ...
            <img src={Image1} alt="" className='w-[2500px] h-[200px] 
             absolute lg:buttom-[2px]' />
          </div>
          {/* second-col */}
          <div className='col-span-2 py-10 pl-8 bg-gradient-to-br from-brandBlue/90 to-brandGreen/90
          ...
          {/* third-col */}
          <div className='col-span-3 py-10 pl-5 bg-gradient-to-br from-primary/90 to-brandBlue/90 text-white rounded-3xl relative h-[320px]
          flex items-end'>
            <div>
              <div className='mb-4'>
